...
#define LAUNCHER_VERSION_STRINGIFY(compatible, feature, patch) wxT(#compatible) wxT(".") wxT(#feature) wxT(".") wxT(#patch)
...
#define RESOURCE_VERSION_STRINGIFY(compatible, feature, patch) wxT(#compatible) wxT(", ") wxT(#feature) wxT(", ") wxT(#patch) wxT(", 0")
